...
Please refer to to issue [#2566](https://github.com/SFBU-SPM/Client-Portal/issues/2566) for more explanation.
...
```yaml
# Check https://github.com/SFBU-SPM/Client-Portal/issues/2566 for details
option_settings:
